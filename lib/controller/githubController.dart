...
import 'package:github_api/utils/constants.dart';
...
class GithubController extends GetxController {
  ...
  void changeFavoriteProfile(int index) {
    ...
    _githubProfile!.favorite
        ? DatabaseFavoriteController.insertFavoriteProfile(_githubProfile!)
        : DatabaseFavoriteController.removeFavoriteProfile(_githubProfile!);
