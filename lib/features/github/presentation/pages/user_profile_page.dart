...
class _UserProfilePageState extends State<UserProfilePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Observer(
        builder: (_) => _getWidgetBasedOnStatus(controller),
      ),
    );
  }
}

Widget _getWidgetBasedOnStatus(UserProfileStore controller) {
  ...
  return Text(controller.userEntity.name ?? controller.userEntity.login);
}
